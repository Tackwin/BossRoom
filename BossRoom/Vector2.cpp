...
bool Vector2::isInRec(const Vector2& pos, const Vector2& size) const {
...
void Vector2::render(sf::RenderTarget& target, Vector2 p, sf::Color color) {
	sf::Vertex ver[2] = {
		sf::Vertex(p, color),
